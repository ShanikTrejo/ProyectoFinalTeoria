...
#endif
static GLuint ciudad_display_list;	//Display List for Justina
...
GLuint createDL()
{
	...
	posgradoDL = glGenLists(1);
	// start list
	glNewList(posgradoDL, GL_COMPILE);
...
void display(void)   // Creamos la funcion donde se dibuja
{
	...
	//pintaTexto(-11, 12.0, -14.0, (void *)font, "Practica 12: Animacion por Maquina de Estad");
	//glColor3f(0.0, 0.40, 0.40);
